  ...
  return (
    <>
      ...
      >
          ...
          <>
            ...
            >
              <div className="relative flex shrink-0 w-[50dvw] h-full">
                <Image
                  className="object-cover w-full h-full"
                  src="/media/img/gallery/DSC_7065-2.jpg"
                  alt="Test"
                  fill
                />
              </div>
              <div className="relative flex shrink-0 w-[50dvw] h-full">
                <Image
                  className="object-cover w-full h-full"
                  src="/media/img/gallery/DSC_9827.jpg"
                  alt="Test"
                  fill
                />
              </div>
              <div className="relative flex shrink-0 w-[50dvw] h-full">
                <Image
                  className="object-cover w-full h-full"
                  src="/media/img/gallery/DSC_9869.jpg"
                  alt="Test"
                  fill
                />
              </div>
        ...
        {/* Join/Contact */}
        <section className="flex justify-center items-start w-full max-w-4xl px-8 py-16 md:py-32">
          <motion.div
